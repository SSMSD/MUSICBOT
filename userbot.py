...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("friendsmastigrou")
                await self.one.join_chat("suraj_saini91")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("friendsmastigrou")
                await self.two.join_chat("suraj_saini91")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("friendsmastigrou")
                await self.three.join_chat("quizbys")
                await self.three.join_chat("suraj_saini91")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("friendsmastigrou")
                await self.four.join_chat("suraj_saini91")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("friendsmastigrou")
