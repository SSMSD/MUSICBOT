...
import config
from SURAJM import Carbon, YouTube, app
from SURAJM.core.call import SURAJ
from SURAJM.misc import db
from SURAJM.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from SURAJM.utils.exceptions import AssistantErr
from SURAJM.utils.inline.play import (stream_markup, queue_markup,

                                          telegram_markup)
from SURAJM.utils.inline.playlist import close_markup
from SURAJM.utils.pastebin import SURAJbin
from SURAJM.utils.stream.queue import put_queue, put_queue_index
from SURAJM.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await SURAJ.force_stop_stream(chat_id)
