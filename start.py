...
from SURAJM import Telegram, YouTube, app
from SURAJM.misc import SUDOERS, _boot_
from SURAJM.plugins.playlist import del_plist_msg
from SURAJM.plugins.sudoers import sudoers_list
from SURAJM.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from SURAJM.utils.formatters import get_readable_time
from SURAJM.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAIElGU6AgRIx7kKhMZiEEWgrk83ixiVAAKzBwACqkfIVNB8kytSvIySHgQ")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/UPSCBPSCGK) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
☆............𝙱𝚈 » [SURAJ SAINI](https://t.me/suraj_saini91)............☆"""
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🏓𝐒𝐔𝐏𝐏𝐎𝐑𝐓🏓", url="https://t.me/UPSCBPSCGK"
                        ),
                    ],
                ]
            )
        ...
        if await is_on_off(config.LOG):
            ...
            return await app.send_message(
                config.LOG_GROUP_ID,
                f"{message.from_user.mention} 𝐉𝐮𝐬𝐭 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 SURAJ 𝐁𝐨𝐭😍.\n\n**𝐔𝐬𝐞𝐫 𝐈𝐝:-** {sender_id}\n**𝐍𝐚𝐦𝐞:-** {sender_name}",
            )
