...
async def gen_thumb(videoid, chat_id):
    ...
    try:
        ...
        bg = Image.open(f"SURAJM/assets/bg.png")
        ...
        font = ImageFont.truetype("SURAJM/assets/font2.ttf", 30)
        ImageFont.truetype("SURAJM/assets/font2.ttf", 70)
        arial = ImageFont.truetype("SURAJM/assets/font2.ttf", 30)
        ImageFont.truetype("SURAJM/assets/font.ttf", 30)
...
async def gen_qthumb(videoid, chat_id):
    ...
    try:
        ...
        draw = ImageDraw.Draw(background)
        font = ImageFont.truetype("SURAJM/assets/font2.ttf", 45)
        ImageFont.truetype("SURAJM/assets/font2.ttf", 70)
        arial = ImageFont.truetype("SURAJM/assets/font2.ttf", 30)
        ImageFont.truetype("SURAJM/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=32)
