...
from SURAJM.utils import get_readable_time
from SURAJM.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAIEl2U6AkSjpLuCM3I2hRJHL9JKA8xgAAIdCQAChLfJVP2HYpbJVL5MHgQ")
    await message.reply_text(
