...
from SURAJM.utils import (Vipbin, get_channeplayCB,
                              seconds_to_min)
from SURAJM.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from SURAJM.utils.decorators.language import language, languageCB
from SURAJM.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://graph.org/file/3904df878c1430939fe60.jpg",
        caption=_["queue_1"],
    )
